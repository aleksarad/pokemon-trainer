...
Pokemon.create(name:"Togepi", poke_type:"Fairy", dex_num:175)
Pokemon.create(name:"Mew", poke_type:"Psychic", dex_num:151)
Pokemon.create(name:"Snorlax", poke_type:"Normal", dex_num:143)
...
Move.create(name: "Rest", move_type: "Psychic", category: "Status")
Move.create(name: "Surf", move_type: "Water", category: "Special")
Move.create(name: "Thunderbolt", move_type: "Electric", category: "Special")
Move.create(name: "Fly", move_type: "Flying", category:"Physical")
Move.create(name: "Crunch", move_type: "Dark", category: "Physical")
Move.create(name: "Dragon Claw", move_type: "Dragon", category: "Physical")
Move.create(name: "Hyper Beam", move_type: "Normal", category: "Special")
...
Move.create(name: "Rock Blast", move_type: "Rock", category: "Physical")
